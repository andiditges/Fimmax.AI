  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Datenschutzerklärung</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Informationen gemäß Art. 13, 14 DSGVO</p>
      </div>
      ...
      <Card>
        ...
        <p className="text-xs text-gray-400 dark:text-gray-500 mt-2">
          Siehe auch <Link href="/impressum" className="text-blue-600 dark:text-blue-400 hover:underline">Impressum</Link>.
        </p>
      </Card>
      ...
      <Card>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">
          ...
          <a href="https://www.anthropic.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">
      ...
      <Card>
        ...
        <ul className="text-sm text-gray-700 dark:text-gray-300 mt-2 space-y-2 list-disc list-inside">
          <li>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500">
        ...
        auch <Link href="/haftungsausschluss" className="text-blue-600 dark:text-blue-400 hover:underline">Haftungsausschluss</Link>
      </p>
    </div>
  )
}
