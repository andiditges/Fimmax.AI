  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Allgemeine Geschäftsbedingungen (AGB)</h1>
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Für die Nutzung von Fimmax.AI</p>
      </div>
      ...
      <Card>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">
          ...
          Michel Ditges (siehe <Link href="/impressum" className="text-blue-600 dark:text-blue-400 hover:underline">Impressum</Link>,
      ...
      <Card>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">
          ...
          zuständig – Näheres in der <Link href="/datenschutz" className="text-blue-600 dark:text-blue-400 hover:underline">Datenschutzerklärung</Link>.
        </p>
      </Card>
      ...
      <Card>
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300 mt-2 leading-relaxed">
          ...
          eingesetzten Auftragsverarbeitern (siehe <Link href="/datenschutz" className="text-blue-600 dark:text-blue-400 hover:underline">Datenschutzerklärung</Link>)
      ...
      <p className="text-xs text-gray-400 dark:text-gray-500">
        ...
        <Link href="/haftungsausschluss" className="text-blue-600 dark:text-blue-400 hover:underline">Haftungsausschluss</Link>{' '}
        und <Link href="/datenschutz" className="text-blue-600 dark:text-blue-400 hover:underline">Datenschutzerklärung</Link>
      </p>
    </div>
  )
}
