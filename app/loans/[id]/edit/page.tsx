...
export default function EditLoan() {
  ...
  return (
    <div className="max-w-xl">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">Kredit bearbeiten</h1>
      <Card>
        <form onSubmit={onSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">davon Renovierung/Sanierung geplant (€)</label>
          ...
          <div className="flex gap-3">
            ...
            <button type="button" onClick={() => router.push(`/loans/${params.id}`)}
              className="px-5 py-3 rounded-xl font-medium text-gray-500 dark:text-gray-400 hover:text-gray-700 hover:dark:text-gray-300 transition-colors">
              Abbrechen
            </button>
          </div>
        </form>
