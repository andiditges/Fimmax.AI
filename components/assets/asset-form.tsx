...
export function AssetForm({ asset }: { asset?: Asset }) {
  ...
  return (
    <div className="max-w-xl">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-6">{asset ? 'Vermögenswert bearbeiten' : 'Vermögenswert erfassen'}</h1>
      <Card>
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-1">Optional – ohne Angabe wird die Kategorie als Bezeichnung angezeigt</p>
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Institut / Anbieter</label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Aktueller Wert (€) *</label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Stand vom</label>
          ...
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mb-1">Optional – wie viel du monatlich regelmäßig einzahlst</p>
