  ...
  return (
    <span className="leading-tight inline-block">
      <span className="font-bold text-blue-700 text-2xl tracking-tight block whitespace-nowrap">
        F<span className="brick-text inline-block">i</span><span className="brick-text relative inline-block align-baseline">
      ...
      <span className="text-xs text-gray-400 dark:text-gray-500 block -mt-0.5">KI-gestützt. Maximal effizient.</span>
    </span>
  )
}
