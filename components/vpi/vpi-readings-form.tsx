      ...
      {open && (
        <form onSubmit={onSubmit} className="grid grid-cols-2 gap-3 bg-gray-50 border border-gray-100 rounded-xl p-4 mt-3">
          <div>
            ...
            <p className="text-xs text-gray-400 mb-1">Für welchen Monat gilt der VPI-Wert unten? Nicht der Einzugsmonat eines Mieters – das hier ist die allgemeine Indextabelle, aus der sich der Basiswert bei jedem indexgemieteten Vertrag automatisch bedient.</p>
