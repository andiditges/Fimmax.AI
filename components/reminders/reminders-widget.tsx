  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200">Erinnerungen & ToDos</h2>
        <Link href="/reminders" className="text-sm text-blue-600 dark:text-blue-400 hover:underline">Alle anzeigen →</Link>
      </div>
      {sorted.length === 0 ? (
        <Card className="text-center py-8 text-gray-400 dark:text-gray-500">Keine offenen Erinnerungen. 🎉</Card>
      ) : (
